...
export default function FilterSidebar({
  ...
  function changePriceFilter(event) {
    ...
    let priceFiltered = collegeList
      .filter(
        (college) =>
          Math.abs(
            parseFloat(college.tuition_out_of_state) - event.target.value
          ) <= 5000
      )
      .sort(
        (a, b) =>
          parseFloat(b.tuition_out_of_state) -
          parseFloat(a.tuition_out_of_state)
      );
  ...
  async function handleChangeSAT(college, sat) {
    let convertedSAT = await convertCollegeSAT(
      `${
  ...
  async function changeSATFilter(event) {
    ...
    const satFiltered = collegeList.filter(
      (_, index) => filteredIndexes[index]
    );
      ...
      <div className="filters">
        ...
        <div className="price-filter-container">
          <div className="price-filter">
            <b>Tuition:</b> ${parseInt(price).toLocaleString()}
          </div>
          <input
        ...
        <div className="act-score-container">
          <div className="act-score">
            <b>ACT:</b> {act ? act : null}
          </div>
          <input
        ...
        <div className="sat-score-container">
          <div className="sat-score">
            <b>SAT:</b> {sat ? sat : null}
          </div>
          <input
        ...
        <div className="enrollment-container">
          <div className="enrollment">
            <b>Enrollment Size:</b> {enrollment?.toLocaleString()}
          </div>
